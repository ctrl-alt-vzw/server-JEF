...
export const script = (handle) => { 
	...
	const prepend = `Respond with the exact answer only. Do not include any extra text before or after the main response. Provide only the answer in plain text. If you answer with multiple items, make a list (1., 2., 3.) separated by newlines (enter). Make the answer as short as possible. Make sure the answer is fitting for a 9 year old. Here is the context: [[CONTEXT]]. `
	...
	switch(handle) {
	  ...
	  case "ANTAGONIST_LOOK": 
	  	return { 
		    ...
		    visual: "Design an isolated isometric game asset pack for an evil villain, in [[CONTEXT]]. the character is described as follows: [[STEP_VALUE]]. \n The asset pack should be arranged as follows: \n Top left: Two arms, fingers pointing downward—one outer left hand and one inner right hand. \n Bottom left: Two legs, feet pointing downward—left and right. \n Right side: The torso and head, facing forward to the right, no arms or legs, torso and head facing right. \n The artwork should be bright, detailed, and colorful while maintaining a playful and immersive feel. Ensure the face is fully visible from the right perspective, avoiding any back-facing views. Ensure the artwork is presented in an isometric perspective, isolated from any distracting background elements, making it easy to integrate into a game engine. Add a contrasting background",
